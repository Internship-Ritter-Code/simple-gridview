          ...
          child: new InkWell(
            onTap: (){
              showDialog(context: context, builder: (_) => AssetGiffyDialog(
                  image: Image.asset('gambar/$gambarMotor', fit: BoxFit.cover,),
                  title: Text(dataMotor['nama'], style: TextStyle(fontWeight: FontWeight.bold, fontSize: 22.0),),
                description: Text(dataMotor['keterangan'], maxLines: 2, textAlign: TextAlign.center, style: TextStyle(fontSize: 20.0),),
              onOkButtonPressed: (){
            ...
            child: new Column(
              children:<Widget>[
                new Hero(
                  tag: dataMotor["nama"],
                  child: Image.asset('gambar/$gambarMotor', fit: BoxFit.contain, width: 100.0, height: 85.0,),
                ),
